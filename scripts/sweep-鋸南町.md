...
実行: 2026-08-17 10:48:32　/　`node scripts/district-sweep.js --district "鋸南町"`
...
| L2 | ちば観光ナビ（千葉県公式）鋸南町 × バーベキュー・キャンプ・グランピング | OK | 1 | 1 | エリアコード 54（/spot/index.html の絞り込みから実測。**推測で振っていない**）/ ジャンル7はグランピング・BBQ場を含むので業態は人が見る / 住所は詳細ページの JSON-LD (PostalAddress) |
| L2 | なっぷ chiba/tateyama_minamiboso | OK | 20 | 0 | robots.txt に Crawl-delay: 30。一覧に住所が無いため名前のみ |
| L2 | じゃらん観光ガイド 鋸南町（cit_124630000 / ジャンル キャンプ・バンガロー・コテージ） | OK | 2 | 2 | ジャンル g2_04 のみ / 一覧は先頭3ページまで / https://www.jalan.net/kankou/cit_124630000/g2_04/page_2/ → HTTP_404 / https://www.jalan.net/kankou/cit_124630000/g2_04/page_3/ → HTTP_404 |
| L1 | 鋸南町公式「泊まる > キャンプ」 | **L1_NOT_FOUND** | – | – | **入口はあるが中身が1件で、しかも住所が無い。**カテゴリ（list167-385.html）に載っているのは「佐久間ダムキャンプ場の予約受付について」の1本だけ。その詳細（1736.html）は 区画数14・期間5/1〜11/30・事前届出制まで書いてあるのに、**キャンプ場の所在地が書かれていない。**ページ内で唯一の住所は問い合わせ先「地域振興課農林水産振興室 安房郡鋸南町下佐久間3458番地」＝**役場の住所**で、**ここから住所を取ると §6-16 の借用をこちらから作る**（北杜市観光協会と同じ型）。なっぷに出ている鋸南ほしふるキャンプ場も載っていない。住所が取れないので L1 として登録しない |
| L1 | 都道府県オープンデータ（千葉） | **L1_NOT_FOUND** | – | – | 未調査 |

**L1_NOT_FOUND は「探したが一覧が存在しない」。**「まだ探していない」とは違う。
次に見る人が同じ探索を繰り返さないために、確認したURLを残しておく。

- **鋸南町公式「泊まる > キャンプ」** — **入口はあるが中身が1件で、しかも住所が無い。**カテゴリ（list167-385.html）に載っているのは「佐久間ダムキャンプ場の予約受付について」の1本だけ。その詳細（1736.html）は 区画数14・期間5/1〜11/30・事前届出制まで書いてあるのに、**キャンプ場の所在地が書かれていない。**ページ内で唯一の住所は問い合わせ先「地域振興課農林水産振興室 安房郡鋸南町下佐久間3458番地」＝**役場の住所**で、**ここから住所を取ると §6-16 の借用をこちらから作る**（北杜市観光協会と同じ型）。なっぷに出ている鋸南ほしふるキャンプ場も載っていない。住所が取れないので L1 として登録しない
  - 確認: https://www.town.kyonan.chiba.jp/site/tourism/list167-385.html
  - 確認: https://www.town.kyonan.chiba.jp/site/tourism/1736.html

取得したページ:

- `L1` https://www.pref.chiba.lg.jp/shousupo/sports-shisetsu/r5/11campjo.html → 200（キャッシュ）
- `L2` https://maruchiba.jp/spot/index_1_2_54_7.html → 200（キャッシュ）
  - 詳細ページ 1 件（住所の取得のため）
...
- `L2` https://www.jalan.net/kankou/cit_124630000/g2_04/ → 200（キャッシュ）
- `L2` https://www.jalan.net/kankou/cit_124630000/g2_04/page_2/ → 404
- `L2` https://www.jalan.net/kankou/cit_124630000/g2_04/page_3/ → 404
  - 詳細ページ 2 件（住所の取得のため）
...
- **表記ゆれ**: BASE1901 / BASE 1901
- **出典**:
  - `L2` ちば観光ナビ（千葉県公式）鋸南町 × バーベキュー・キャンプ・グランピング — https://maruchiba.jp/spot/detail_11283.html
  - `L2` じゃらん観光ガイド 鋸南町（cit_124630000 / ジャンル キャンプ・バンガロー・コテージ） — https://www.jalan.net/kankou/spt_guide000000223448/
...
- **住所**: 千葉県安房郡鋸南町元名994-3
- **出典**:
  - `L2` じゃらん観光ガイド 鋸南町（cit_124630000 / ジャンル キャンプ・バンガロー・コテージ） — https://www.jalan.net/kankou/spt_guide000000223449/
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 20 件 | **20** |
...
| ちば観光ナビ（千葉県公式）鋸南町 × バーベキュー・キャンプ・グランピング | 1 | 0 | 1 | 0 | 0 | OK |
| なっぷ chiba/tateyama_minamiboso | 20 | 0 | 0 | 20 | 0 | OK |
| じゃらん観光ガイド 鋸南町（cit_124630000 / ジャンル キャンプ・バンガロー・コテージ） | 2 | 0 | 2 | 0 | 0 | OK |
...
| しおさいキャンプフィールド | L2 nap-camp | 一覧に住所が無い | https://www.nap-camp.com/chiba/tateyama_minamiboso/list |
