...
実行: 2026-08-15 11:48:10　/　`node scripts/district-sweep.js --district "榛原郡川根本町犬間長嶋公園敷"`
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 85 件 | **93** |
...
|---|---|---|---|---|---|---|
| 川根本町公式 キャンプ（詳細は川根本町観光協会 okuooi.gr.jp） | 5 | 0 | 0 | 0 | 5 | OK |
| なっぷ shizuoka/oigawa_sumatakyo_kawane | 20 | 0 | 0 | 8 | 12 | OK |
| じゃらん観光ガイド 川根本町（cit_224290000 / ジャンル キャンプ・バンガロー・コテージ） | 6 | 0 | 0 | 0 | 6 | OK |
| hinata スポット 大井川・寸又峡・川根（tokai/shizuoka/2713） | 12 | 0 | 0 | 0 | 12 | OK |
