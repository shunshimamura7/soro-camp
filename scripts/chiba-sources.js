 ...
 * ## ★ 層は L2 で入れてある（暫定）
 *
 * **前例では市町村公式は L1**（君津市公式82% / 相模原市ミドナビ / 山北町公式 / 松田町公式）。
 * だが「ちば観光ナビと同じ手順で、可逆な判断は測ってから」という方針に従い、
 * **まず L2 で入れて網羅率を測る。**7割を超えれば L1 に上げる（1行）。
 *
 * **母数が1件しかないので、率としてはほぼ意味を持たない**ことに注意
 * （南房総市観光協会が母数1で100%と出るのと同じ）。
 * **率ではなく「他のどのソースにも無い1件を拾えるか」で判断すること。**
 *
 * ## 更新日と現況
 *
