...
実行: 2026-08-15 11:50:40　/　`node scripts/district-sweep.js --district "相模原市緑区青野原"`
...
| L2 | hinata スポット 相模原（kanto/kanagawa/1906） | OK | 29 | 1 | 一覧は先頭3ページまで |
...
|---|---|---|---|---|
| `aonohara-auto` 青野原オートキャンプ場 | 青野原オートキャンプ場 | 名前 | HIGH | L1+L2+L3 |
| `norolodge` 青野原野呂ロッジキャンプ場 | 青野原 野呂ロッジキャンプ場 | 名前 | HIGH | L1+L2+L3 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 25 件 | **58** |
...
| hinata スポット 相模原（kanto/kanagawa/1906） | 29 | 0 | 1 | 0 | 28 | OK |
...
| 合流先 | 分類 | 合流した住所なしの出典 |
|---|---|---|
| 青野原 野呂ロッジキャンプ場 | IN_DATA | L2 nap-camp / L3 japancamp |
