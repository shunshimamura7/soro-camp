...
c.closedNote =
  '2026-08-11、座標の目視取得作業中に閉業が判明（しゅんの目視）。' +
  '**Web 上の一次情報には閉業の告知が無い。**同日の実測で、施設公式 https://the-do-c.com は' +
  '2026年の表記と料金表・予約サイトの事前決済が生きたままで、' +
  '村公式 https://www.doshi-kanko.jp/camp/murokubo-greenpark/ にも閉業の記載が無かった。' +
  'ここに挙げた URL は閉業の出典ではなく、**告知が無いことの記録**である。' +
  '直接の出典が手に入ったら差し替えること。' +
  '2026-08-10 に「村公式の一覧＋施設公式の2026年表記＋予約サイトの事前決済」の3つが揃った' +
  '候補として追加した翌日の判明で、この3点が揃っても営業の証明にならない実例（§6-22）。';
