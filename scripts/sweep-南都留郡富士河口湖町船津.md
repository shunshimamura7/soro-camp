...
実行: 2026-08-15 11:44:08　/　`node scripts/district-sweep.js --district "南都留郡富士河口湖町船津"`
...
|---|---|---|---|---|---|
| L1 | 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | OK | 17 | 3 | ホテル・旅館と同じ一覧。詳細ページの本文にキャンプ関連語があるかで選別している。町公式サイトはこのサイトへ誘導しているだけなので1ソース扱い（§6-15） / 宿泊施設 231 件のうち、本文にキャンプ関連語があった 17 件を残した（判定語: キャンプ/テント/オートサイト/バンガロー/野営） |
...
| L2 | hinata スポット 河口湖・西湖・富士吉田・精進湖・本栖湖（koushinetsu/yamanashi/2005） | OK | 45 | 1 | 一覧は先頭3ページまで |
...
- **出典**:
  - `L1` 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる — https://fujisan.ne.jp/sightseeing/6526/

### 2. tourist base kawaguchiko（ツーリストベース河口湖）

- **分類**: MISSING
- **confidence**: HIGH（層: L1）
- **住所**: 山梨県南都留郡富士河口湖町船津3636
- **出典**:
  - `L1` 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる — https://fujisan.ne.jp/sightseeing/4023/

### 3. ニューブリッジキャンプ場

- **分類**: MISSING
- **confidence**: HIGH（層: L1）
- **住所**: 山梨県南都留郡富士河口湖町船津1016
- **出典**:
  - `L1` 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる — https://fujisan.ne.jp/sightseeing/2179/
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 82 件 | **134** |
...
|---|---|---|---|---|---|---|
| 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | 17 | 0 | 3 | 0 | 14 | OK |
| なっぷ yamanashi/motosuko_nishiko_kawaguchiko_fuzjiyoshida_shojiko | 20 | 0 | 2 | 6 | 12 | OK |
| じゃらん観光ガイド 富士河口湖町（cit_194300000 / ジャンル キャンプ・バンガロー・コテージ） | 22 | 0 | 0 | 0 | 22 | OK |
| hinata スポット 河口湖・西湖・富士吉田・精進湖・本栖湖（koushinetsu/yamanashi/2005） | 45 | 0 | 1 | 0 | 44 | OK |
