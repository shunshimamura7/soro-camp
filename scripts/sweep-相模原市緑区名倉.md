...
実行: 2026-08-15 11:48:51　/　`node scripts/district-sweep.js --district "相模原市緑区名倉"`
...
|---|---|---|---|---|---|
| L1 | 相模原市観光協会 キャンプ場一覧 | OK | 22 | 1 |  |
| L1 | 相模原市 ぐるっと緑区ミドナビ（市公式）キャンプ | OK | 17 | 1 |  |
...
|---|---|---|---|---|
| `akiyamagawa-camp` 秋山川キャンプ場 | 秋山川キャンプ場 | 名前 | HIGH | L1+L2+L3 |
...
|---|---|---|---|---|---|---|
| 相模原市観光協会 キャンプ場一覧 | 22 | 0 | 1 | 1 | 20 | OK |
| 相模原市 ぐるっと緑区ミドナビ（市公式）キャンプ | 17 | 0 | 1 | 0 | 16 | OK |
...
| キャンナビ（japancamp.jp）神奈川県 | 69 | 0 | 3 | 0 | 66 | OK |
