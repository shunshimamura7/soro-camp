...
実行: 2026-08-10 14:11:09　/　`node scripts/district-sweep.js --district "富士宮市猪之頭"`
...
| L2 | hinata スポット 御殿場・富士（tokai/shizuoka/2710） | OK | 58 | 7 | 一覧は先頭3ページまで / 住所を取りに行く詳細ページを 45 件で打ち切った（対象 58 件）。**打ち切った分はこの検査に載らない** |
...
### 1. Foresters Village Kobitto あさぎりキャンプフィールド
...
- **住所**: 静岡県富士宮市猪之頭2351
- **出典**:
  - `L2` じゃらん観光ガイド 富士宮市（cit_222070000 / ジャンル キャンプ・バンガロー・コテージ） — https://www.jalan.net/kankou/spt_guide000000198771/
  - `L2` hinata スポット 御殿場・富士（tokai/shizuoka/2710） — https://camp-spot.hinata.me/spots/penguin-mura
...
- **住所**: 富士宮市猪之頭人穴道1816-9
- **表記ゆれ**: Field Dogs Garden / Ｆｉｅｌｄ Ｄｏｇｓ Ｇａｒｄｅｎ
- **出典**:
...
|---|---|---|---|---|
| `asagiri-greenpark-camp` 朝霧高原グリーンパーク | 朝霧高原オートキャンプ場 | 名前 | MID | L2+L3 |
| `asagiri-jamboree` 朝霧ジャンボリーオートキャンプ場 | 朝霧ジャンボリーオートキャンプ場 | 名前 | LOW | L2+L3 |
