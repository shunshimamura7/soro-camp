...
実行: 2026-08-15 12:08:23　/　`node scripts/district-sweep.js --district "静岡市葵区新間"`
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 80 件 | **96** |
...
|---|---|---|---|---|---|---|
| なっぷ shizuoka/shizuoka_shimizu | 20 | 0 | 0 | 2 | 18 | OK |
| じゃらん観光ガイド 静岡市清水区（cit_221030000 / ジャンル キャンプ・バンガロー・コテージ） | 8 | 0 | 0 | 0 | 8 | OK |
| hinata スポット 静岡・清水（tokai/shizuoka/2711） | 12 | 0 | 0 | 0 | 12 | OK |
