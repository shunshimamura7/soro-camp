...
- 全 192件中、プレースホルダ日付: **33件**
- うち tel と officialUrl がどちらもないもの: **28件**（裏取りの手がかりなし）
- `lastVerified` が空: 14件

※ 判定のみ。data/campgrounds.json は変更していない。

## プレースホルダ日付（2025-01-01）の 33件
...
| `omuroyama-camp` | 大室山キャンプ場（伊東市営） | 静岡 | 伊東市 | あり | なし |
| `ogurabashi-kasenjiki` | 小倉橋河川敷 | 神奈川 | 相模原市緑区 | なし | なし |
| `takadabashi-kasenjiki` | 高田橋河川敷 | 神奈川 | 相模原市中央区 | なし | なし |
| `nishizato-camp-tekichi` | 西里キャンプ適地 | 静岡 | 静岡市清水区 | なし | なし |
| `numazu-shimin-no-mori` | 沼津市民の森 | 静岡 | 沼津市 | あり | なし |
| `kamioshima-camp` | 上大島キャンプ場 | 神奈川 | 相模原市緑区 | あり | なし |
