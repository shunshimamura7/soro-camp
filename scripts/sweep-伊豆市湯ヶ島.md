...
実行: 2026-08-10 14:09:14　/　`node scripts/district-sweep.js --district "伊豆市湯ヶ島"`
...
| L2 | hinata スポット 中伊豆（tokai/shizuoka/2708） | OK | 8 | 1 | 一覧は先頭3ページまで |
...
|---|---|---|---|---|
| `amagi-kogen` | 天城高原キャンプ場 | 静岡県伊豆市湯ヶ島1918 | active |  |
| `nekokodake-camp` | 猫越岳キャンプ場 | 静岡県伊豆市湯ヶ島1638 | active |  |
