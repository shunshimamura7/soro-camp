...
実行: 2026-08-15 11:50:16　/　`node scripts/district-sweep.js --district "相模原市緑区青根"`
...
|---|---|---|---|---|---|
| L1 | 相模原市観光協会 キャンプ場一覧 | OK | 22 | 6 |  |
| L1 | 相模原市 ぐるっと緑区ミドナビ（市公式）キャンプ | OK | 17 | 6 |  |
...
| L2 | じゃらん観光ガイド 相模原市緑区（cit_141510000 / ジャンル キャンプ・バンガロー・コテージ） | OK | 18 | 6 | ジャンル g2_04 のみ / 一覧は先頭3ページまで / https://www.jalan.net/kankou/cit_141510000/g2_04/page_2/ → HTTP_404 / https://www.jalan.net/kankou/cit_141510000/g2_04/page_3/ → HTTP_404 |
| L2 | hinata スポット 相模原（kanto/kanagawa/1906） | OK | 29 | 8 | 一覧は先頭3ページまで |
| L3 | キャンナビ（japancamp.jp）神奈川県 | OK | 69 | 9 | 一覧は先頭8ページまで（無いページは404として記録される） / https://japancamp.jp/camp_area/14-kanagawa/page/4/ → HTTP_404 / https://japancamp.jp/camp_area/14-kanagawa/page/5/ → HTTP_404 / https://japancamp.jp/camp_area/14-kanagawa/page/6/ → HTTP_404 / https://japancamp.jp/camp_area/14-kanagawa/page/7/ → HTTP_404 / https://japancamp.jp/camp_area/14-kanagawa/page/8/ → HTTP_404 |
...
- **分類**: MISSING
- **confidence**: HIGH（層: L1 + L2）
- **住所**: 神奈川県相模原市緑区青根807 / 相模原市緑区青根807-2
- **表記ゆれ**: 緑の休暇村 青根キャンプ場 / 緑の休暇村青根キャンプ場 / 緑の休暇村・青根キャンプ場
- **同じ番地に別名**: 青根キャンプ場（同一施設の別表記か、敷地内の別施設か。番地では寄せていない）
- **出典**:
  - `L1` 相模原市観光協会 キャンプ場一覧 — https://www.e-sagamihara.com/camp/camp-692/
  - `L1` 相模原市 ぐるっと緑区ミドナビ（市公式）キャンプ — https://midori.city.sagamihara.kanagawa.jp/2023/02/14/aonecamp/
  ...
  - `L2` じゃらん観光ガイド 相模原市緑区（cit_141510000 / ジャンル キャンプ・バンガロー・コテージ） — https://www.jalan.net/kankou/spt_14422ca3430053407/
  - `L2` hinata スポット 相模原（kanto/kanagawa/1906） — https://camp-spot.hinata.me/spots/midorinokyukamura-aone
...
- **住所**: 神奈川県相模原市緑区青根3685 / 相模原市津久井町青根3685
...
| `konomasawa-camp` このまさわキャンプ場 | このまさわキャンプ場 | 名前 | HIGH | L1+L2+L3 |
| `aone` 青根キャンプ場 | 青根キャンプ場 | 名前 | LOW | L3 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 25 件 | **51** |
...
|---|---|---|---|---|---|---|
| 相模原市観光協会 キャンプ場一覧 | 22 | 0 | 6 | 1 | 15 | OK |
| 相模原市 ぐるっと緑区ミドナビ（市公式）キャンプ | 17 | 0 | 6 | 0 | 11 | OK |
| 神奈川県公式 県央地域のバーベキュー・キャンプ | 4 | 0 | 0 | 2 | 2 | OK |
| なっぷ kanagawa/sagamihara | 20 | 0 | 4 | 6 | 10 | OK |
| じゃらん観光ガイド 相模原市緑区（cit_141510000 / ジャンル キャンプ・バンガロー・コテージ） | 18 | 0 | 6 | 0 | 12 | OK |
| hinata スポット 相模原（kanto/kanagawa/1906） | 29 | 0 | 8 | 0 | 21 | OK |
| キャンナビ（japancamp.jp）神奈川県 | 69 | 0 | 9 | 0 | 60 | OK |
...
| 緑の休暇村 青根キャンプ場 | MISSING | L2 nap-camp |
