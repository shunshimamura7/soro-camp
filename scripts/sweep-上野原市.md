...
実行: 2026-08-16 14:08:49　/　`node scripts/district-sweep.js --district "上野原市"`
...
| `walkerplus` | 平野田休養村キャンプ場 | 山梨県上野原市 | MISSING |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 26 件 | **26** |
...
| やまなし観光推進機構 大月・都留エリアのキャンプ場 | 24 | 0 | 0 | 6 | 18 | OK |
...
| 名前 | 住所 | 出典（層 / ソース） |
|---|---|---|
| 鹿留オートキャンプ場 | 都留市鹿留1180 | L2 yamanashi-kankou-otsuki |
