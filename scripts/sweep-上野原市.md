...
実行: 2026-08-15 11:40:08　/　`node scripts/district-sweep.js --district "上野原市"`
...
- `L2` https://www.jalan.net/kankou/cit_192120000/g2_04/page_3/ → 404
  - 詳細ページ 6 件（住所の取得のため）
- `L3` https://japancamp.jp/camp_area/19-yamanashi/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/2/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/3/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/4/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/5/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/6/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/7/ → 200
- `L3` https://japancamp.jp/camp_area/19-yamanashi/page/8/ → 200
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 97 件 | **97** |
...
|---|---|---|---|---|---|---|
| 上野原市公式 発見うえのはら キャンプ | 4 | 0 | 4 | 0 | 0 | OK |
| やまなし観光推進機構 大月・都留エリアのキャンプ場 | 24 | 0 | 0 | 2 | 22 | OK |
| なっぷ yamanashi/otsuki_turushi | 20 | 0 | 0 | 14 | 6 | OK |
| じゃらん観光ガイド 上野原市（cit_192120000 / ジャンル キャンプ・バンガロー・コテージ） | 6 | 0 | 6 | 0 | 0 | OK |
...
| 鹿留オートキャンプ場 | 都留市鹿留1180 / 都留市鹿留1281 | L2 yamanashi-kankou-otsuki / L3 japancamp |
...
| 宝の山ふれあいの里 | 都留市大幡5108 | L2 yamanashi-kankou-otsuki |
