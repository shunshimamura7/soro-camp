...
実行: 2026-08-15 11:43:32　/　`node scripts/district-sweep.js --district "南都留郡富士河口湖町富士ヶ嶺"`
...
|---|---|---|---|---|---|
| L1 | 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | OK | 17 | 0 | ホテル・旅館と同じ一覧。詳細ページの本文にキャンプ関連語があるかで選別している。町公式サイトはこのサイトへ誘導しているだけなので1ソース扱い（§6-15） / 宿泊施設 231 件のうち、本文にキャンプ関連語があった 17 件を残した（判定語: キャンプ/テント/オートサイト/バンガロー/野営） |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 82 件 | **138** |
...
|---|---|---|---|---|---|---|
| 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | 17 | 0 | 0 | 0 | 17 | OK |
