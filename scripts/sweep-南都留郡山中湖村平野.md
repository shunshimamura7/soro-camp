...
実行: 2026-08-15 11:44:26　/　`node scripts/district-sweep.js --district "南都留郡山中湖村平野"`
...
|---|---|---|---|---|---|
| L1 | 山中湖観光協会 泊まる | OK | 17 | 12 | 一覧は先頭5ページまで / 宿泊施設 192 件のうち、本文にキャンプ関連語があった 18 件を残した（判定語: キャンプ/テント/オートサイト/バンガロー/野営） |
...
- **住所**: 山梨県南都留郡山中湖村平野508 / 山梨県南都留郡山中湖村平野508-123 / 南都留郡山中湖村平野508
- **出典**:
  - `L1` 山中湖観光協会 泊まる — https://lake-yamanakako.com/reserve/10109
...
- **分類**: MISSING
- **confidence**: HIGH（層: L1）
- **住所**: 山梨県南都留郡山中湖村平野3189-3
- **出典**:
  - `L1` 山中湖観光協会 泊まる — https://lake-yamanakako.com/reserve/10347

### 9. LAKE LODGE YAMANAKA

- **分類**: MISSING
- **confidence**: HIGH（層: L1 + L2）
- **住所**: 山梨県南都留郡山中湖村平野479
- **表記ゆれ**: LAKE LODGE YAMANAKA / Lake Lodge YAMANAKA
- **出典**:
  - `L1` 山中湖観光協会 泊まる — https://lake-yamanakako.com/reserve/10134
  - `L2` なっぷ yamanashi/yamanakako_oshino — https://www.nap-camp.com/yamanashi/yamanakako_oshino/list
  - `L2` なっぷ yamanashi/yamanakako_oshino — https://www.nap-camp.com/yamanashi/yamanakako_oshino/list?page=2
...
- **同じ番地に別名**: 山中湖みなみオートキャンプ場（同一施設の別表記か、敷地内の別施設か。番地では寄せていない）
- **出典**:
  - `L1` 山中湖観光協会 泊まる — https://lake-yamanakako.com/reserve/10042
...
- **confidence**: LOW（層: L3）
- **住所**: 南都留郡山中湖村平野2431-2
- **同じ番地に別名**: sotosotodays CAMPGROUNDS 山中湖みさき（同一施設の別表記か、敷地内の別施設か。番地では寄せていない）
- **出典**:
  - `L3` キャンナビ（japancamp.jp）山梨県 — https://japancamp.jp/camp_area/19-yamanashi/
  - `L3` キャンナビ（japancamp.jp）山梨県 — https://japancamp.jp/camp_area/19-yamanashi/page/2/
  - `L3` キャンナビ（japancamp.jp）山梨県 — https://japancamp.jp/camp_area/19-yamanashi/page/3/
...
|---|---|---|---|---|
| `fujigoko-auto-camp` | 富士五湖オートキャンプ場 | 山梨県南都留郡山中湖村平野2563-1 | unverified | true |
...
| `yamanakako-misaki` sotosotodays 山中湖みさき | sotosotodays CAMPGROUNDS 山中湖みさき | 番地（名前は不一致） | HIGH | L1+L2 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 80 件 | **90** |
...
|---|---|---|---|---|---|---|
| 山中湖観光協会 泊まる | 17 | 0 | 12 | 0 | 5 | OK |
| なっぷ yamanashi/yamanakako_oshino | 20 | 0 | 14 | 2 | 4 | OK |
| じゃらん観光ガイド 山中湖村（cit_194250000 / ジャンル キャンプ・バンガロー・コテージ） | 6 | 0 | 6 | 0 | 0 | OK |
| hinata スポット 山中湖・忍野（koushinetsu/yamanashi/2004） | 18 | 0 | 15 | 0 | 3 | OK |
| キャンナビ（japancamp.jp）山梨県 | 608 | 0 | 24 | 8 | 576 | OK |
...
| 名前 | 住所 | 出典（層 / ソース） |
|---|---|---|
| キャンプ・アンド・キャビンズ山中湖 | 山梨県南都留郡山中湖村山中287-1 | L1 lake-yamanakako |
| 富士見荘キャンプ場 | 山梨県南都留郡山中湖村山中339-3 | L1 lake-yamanakako |
| ヴィヒタ山中湖 | 山梨県南都留郡山中湖村山中236-17 | L1 lake-yamanakako |
| GRAMERCY VILLAGE山中湖GLAMPING&SAUNA | 山梨県南都留郡山中湖村山中379-1 | L1 lake-yamanakako |
| ザデイ・ポストジェネラルグランピングビィレッジ山中湖 | 山梨県南都留郡山中湖村山中217-1 | L1 lake-yamanakako |
| moss camp field | 山梨県南都留郡山中湖村山中1300-1 | L2 nap-camp / L2 hinata-spot |
...
| 合流先 | 分類 | 合流した住所なしの出典 |
|---|---|---|
| 村営山中湖キャンプ場 | IN_DATA | L2 nap-camp |
| the508 | MISSING | L2 nap-camp |
| LAKE LODGE YAMANAKA | MISSING | L2 nap-camp |
| VIASSO（ビアッソ） | MISSING | L2 nap-camp |
| MaukaResortAZMY | MISSING | L2 nap-camp |
| 山中湖みなみオートキャンプ場 | IN_DATA | L2 nap-camp |
| 東照館 オートキャンプ山中湖 | MISSING | L2 nap-camp |
