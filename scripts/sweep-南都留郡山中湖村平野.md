...
実行: 2026-08-10 14:09:26　/　`node scripts/district-sweep.js --district "南都留郡山中湖村平野"`
...
- **同じ番地に別名**: 村営山中湖キャンプ場 / PICA山中湖（同一施設の別表記か、敷地内の別施設か。番地では寄せていない）
- **出典**:
...
|---|---|---|---|---|
| `muraei-yamanakako` 村営山中湖キャンプ場 | 村営山中湖キャンプ場 | 名前 | MID | L2 |
