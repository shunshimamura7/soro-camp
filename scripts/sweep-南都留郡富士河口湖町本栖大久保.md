# 地区スイープ: 南都留郡富士河口湖町本栖大久保

実行: 2026-08-15 11:43:50　/　`node scripts/district-sweep.js --district "南都留郡富士河口湖町本栖大久保"`
...
| L2 | じゃらん観光ガイド 富士河口湖町（cit_194300000 / ジャンル キャンプ・バンガロー・コテージ） | OK | 22 | 1 | ジャンル g2_04 のみ / 一覧は先頭3ページまで / https://www.jalan.net/kankou/cit_194300000/g2_04/page_2/ → HTTP_404 / https://www.jalan.net/kankou/cit_194300000/g2_04/page_3/ → HTTP_404 |
...
- **住所**: 山梨県南都留郡富士河口湖町本栖19 / 南都留郡富士河口湖町本栖
...
### 2. 本栖湖スポーツセンター（本栖湖 SUMIKA CAMP FIELD）
...
|---|---|---|---|---|
| `motosu-shore-camp` 本栖湖キャンプ場 | 本栖湖キャンプ場 | 名前 | HIGH | L1+L2+L3 |
| `motosulakeside` 本栖レークサイドキャンプ場 | 本栖レークサイドキャンプ場 | 名前 | HIGH | L1 |
...
|---|---|---|---|---|---|---|
| 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | 17 | 0 | 2 | 0 | 15 | OK |
| なっぷ yamanashi/motosuko_nishiko_kawaguchiko_fuzjiyoshida_shojiko | 20 | 0 | 0 | 6 | 14 | OK |
| じゃらん観光ガイド 富士河口湖町（cit_194300000 / ジャンル キャンプ・バンガロー・コテージ） | 22 | 0 | 1 | 0 | 21 | OK |
