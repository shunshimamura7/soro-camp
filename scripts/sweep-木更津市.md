...
- **confidence**: LOW（層: L2）
- **住所**: 千葉県木更津市金田東2-10-1
- **同じ番地に別名**: 木更津かんらんしゃパーク キサラピア（同一施設の別表記か、敷地内の別施設か。番地では寄せていない）
- **出典**:
  - `L2` じゃらん観光ガイド 木更津市（cit_122060000 / ジャンル キャンプ・バンガロー・コテージ） — https://www.jalan.net/kankou/spt_guide000000185371/
...
| | 意味 | 件数 |
|---|---|---|
| **b1** | **住所が無い**（名前だけ）。他ソースとも合流できなかった。原因は2つ（下記で分割） | **13** |
...
| 木更津市公式 観光情報「目的別で探す > 山であそぶ」 | 5 | 0 | 1 | 4 | 0 | OK |
...
**⚠ 原因が2つある。分けてある。** b1-1（ソース側の仕様）13 件 / b1-2（取得失敗）0 件。
...
| オートキャンプ・フルーツ村 | L2 nap-camp | 一覧に住所が無い | https://www.nap-camp.com/chiba/kisarazu_kimitsu_uttsu/list |
...
| 清和県民の森キャンプ場 | 千葉県君津市豊英662-1 | L1 pref-chiba-sports / L2 nap-camp |
