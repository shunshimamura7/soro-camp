...
実行: 2026-08-15 11:49:03　/　`node scripts/district-sweep.js --district "相模原市緑区大島"`
...
| L2 | 神奈川県公式 県央地域のバーベキュー・キャンプ | OK | 4 | 1 | 実測4件（相模原2 / 海老名1 / 愛川1）。本文の表は他団体の一覧へのリンク集で施設ではない |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 25 件 | **60** |
...
| 神奈川県公式 県央地域のバーベキュー・キャンプ | 4 | 0 | 1 | 2 | 1 | OK |
| なっぷ kanagawa/sagamihara | 20 | 0 | 0 | 6 | 14 | OK |
| じゃらん観光ガイド 相模原市緑区（cit_141510000 / ジャンル キャンプ・バンガロー・コテージ） | 18 | 0 | 1 | 0 | 17 | OK |
