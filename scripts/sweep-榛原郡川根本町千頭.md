...
実行: 2026-08-10 10:27:16　/　`node scripts/district-sweep.js --district "榛原郡川根本町千頭"`
...
|---|---|---|---|---|---|
| L1 | 川根本町公式 キャンプ（詳細は川根本町観光協会 okuooi.gr.jp） | OK | 5 | 1 | **町公式の一覧は、全件が観光協会 okuooi.gr.jp の詳細ページへ直リンクしている。独立した2ソースではないので1ソースとして登録した（§6-15）。** |
| L2 | なっぷ shizuoka/oigawa_sumatakyo_kawane | OK | 20 | 0 | robots.txt に Crawl-delay: 30。一覧に住所が無いため名前のみ |
| L2 | じゃらん観光ガイド 川根本町（cit_224290000 / ジャンル キャンプ・バンガロー・コテージ） | OK | 6 | 1 | ジャンル g2_04 のみ / 一覧は先頭3ページまで / https://www.jalan.net/kankou/cit_224290000/g2_04/page_2/ → HTTP_404 / https://www.jalan.net/kankou/cit_224290000/g2_04/page_3/ → HTTP_404 |
| L2 | hinata スポット 大井川・寸又峡・川根（tokai/shizuoka/2713） | OK | 12 | 1 | 一覧は先頭3ページまで |
...
| L1 | 川根本町観光協会（okuooi.gr.jp）を独立ソースとして | **L1_NOT_FOUND** | – | – | 町公式の一覧が観光協会の詳細ページへ全件直リンクしており、同じ元データ。独立した2ソースにならないので1ソースに畳んだ（§6-15） |
...
- **川根本町観光協会（okuooi.gr.jp）を独立ソースとして** — 町公式の一覧が観光協会の詳細ページへ全件直リンクしており、同じ元データ。独立した2ソースにならないので1ソースに畳んだ（§6-15）
  - 確認: https://okuooi.gr.jp/outdoor/details.php?id=79
...
|---|---|---|---|---|---|
| 川根本町公式 キャンプ（詳細は川根本町観光協会 okuooi.gr.jp） | 5 | 8 | 5 | 63% | okooigawa-lake, sumatakyo-camp, fudonotaki-auto |
...
|---|---|---|---|---|
| `okooigawa-lake` | 奥大井湖上キャンプ場 | 静岡県榛原郡川根本町千頭 | active |  |
| `sumatakyo-camp` | 寸又峡温泉キャンプ場 | 静岡県榛原郡川根本町千頭1225 | active |  |
