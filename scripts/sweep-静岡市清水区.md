...
実行: 2026-08-15 12:01:53　/　`node scripts/district-sweep.js --district "静岡市清水区"`
...
| b3 | 住所なしの項目が地区内バケットに**合流した**（＝漏れていない。参考） | 4 |
...
|---|---|---|---|---|---|---|
| なっぷ shizuoka/shizuoka_shimizu | 20 | 0 | 8 | 2 | 10 | OK |
| じゃらん観光ガイド 静岡市清水区（cit_221030000 / ジャンル キャンプ・バンガロー・コテージ） | 8 | 0 | 2 | 0 | 6 | OK |
| hinata スポット 静岡・清水（tokai/shizuoka/2711） | 12 | 0 | 4 | 0 | 8 | OK |
| キャンナビ（japancamp.jp）静岡県 | 600 | 0 | 16 | 8 | 576 | OK |
...
| 南アルプス井川オートキャンプ場 | 静岡県静岡市葵区田代449-2 / 静岡市葵区田代449-2 | L2 nap-camp / L2 jalan / L2 hinata-spot / L3 japancamp |
...
| 赤石小屋 | 静岡県静岡市葵区田代 | L2 hinata-spot |
