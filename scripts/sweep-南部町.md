...
実行: 2026-08-16 13:17:13　/　`node scripts/district-sweep.js --district "南部町"`
...
| `nekumasanso-auto` 福士川根熊山荘ファミリーオートキャンプ場 | 福士川根熊山荘ファミリーオートキャンプ場 | 名前 | LOW | L2 |
| `fukushigawa-auto` 福士川オートキャンプ場 | 福士川オートキャンプ場 | 名前 | LOW | L2 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 14 件 | **14** |
