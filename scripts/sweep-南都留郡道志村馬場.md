...
実行: 2026-08-10 14:10:53　/　`node scripts/district-sweep.js --district "南都留郡道志村馬場"`
...
| L2 | hinata スポット 大月・都留（koushinetsu/yamanashi/2003） | OK | 60 | 1 | 一覧は先頭3ページまで / 住所を取りに行く詳細ページを 45 件で打ち切った（対象 60 件）。**打ち切った分はこの検査に載らない** |
...
### 1. WOODSMAN CAMP GROUND

- **分類**: MISSING
- **confidence**: LOW（層: L2）
- **住所**: 山梨県南都留郡道志村馬場5876
- **出典**:
  - `L2` hinata スポット 大月・都留（koushinetsu/yamanashi/2003） — https://camp-spot.hinata.me/spots/woodsman
