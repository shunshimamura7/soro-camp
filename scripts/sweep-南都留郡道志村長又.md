...
実行: 2026-08-10 14:10:51　/　`node scripts/district-sweep.js --district "南都留郡道志村長又"`
...
| L2 | hinata スポット 大月・都留（koushinetsu/yamanashi/2003） | OK | 60 | 2 | 一覧は先頭3ページまで / 住所を取りに行く詳細ページを 45 件で打ち切った（対象 60 件）。**打ち切った分はこの検査に載らない** |
