...
実行: 2026-08-16 14:07:51　/　`node scripts/district-sweep.js --district "山中湖村"`
...
|---|---|---|---|---|---|
| L1 | 山中湖観光協会 泊まる | OK | 17 | 17 | 一覧は先頭5ページまで / 宿泊施設 192 件のうち、本文にキャンプ関連語があった 18 件を残した（判定語: キャンプ/テント/オートサイト/バンガロー/野営） |
...
| L2 | hinata スポット 山中湖・忍野（koushinetsu/yamanashi/2004） | OK | 18 | 18 | 一覧は先頭3ページまで |
...
- **分類**: MISSING
- **confidence**: HIGH（層: L1 + L2）
- **住所**: 山梨県南都留郡山中湖村平野508 / 山梨県南都留郡山中湖村平野508-123
- **出典**:
...
### 12. GRAMERCY VILLAGE山中湖GLAMPING&SAUNA
...
- **分類**: MISSING
- **confidence**: LOW（層: L2）
- **住所**: 山梨県南都留郡山中湖村中山865-111
- **出典**:
  - `L2` hinata スポット 山中湖・忍野（koushinetsu/yamanashi/2004） — https://camp-spot.hinata.me/spots/mori
...
- **住所**: 山梨県南都留郡山中湖村旭日丘
- **出典**:
  - `L2` hinata スポット 山中湖・忍野（koushinetsu/yamanashi/2004） — https://camp-spot.hinata.me/spots/yamanakanoeijo
...
| b3 | 住所なしの項目が地区内バケットに**合流した**（＝漏れていない。参考） | 8 |
...
|---|---|---|---|---|---|---|
| 山中湖観光協会 泊まる | 17 | 0 | 17 | 0 | 0 | OK |
| なっぷ yamanashi/yamanakako_oshino | 20 | 0 | 16 | 4 | 0 | OK |
| じゃらん観光ガイド 山中湖村（cit_194250000 / ジャンル キャンプ・バンガロー・コテージ） | 6 | 0 | 6 | 0 | 0 | OK |
| hinata スポット 山中湖・忍野（koushinetsu/yamanashi/2004） | 18 | 0 | 18 | 0 | 0 | OK |
...
| 名前 | 出典（層 / ソース） | 原因 | URL |
|---|---|---|---|
| LScamp山中湖 | L2 nap-camp | 一覧に住所が無い | https://www.nap-camp.com/yamanashi/yamanakako_oshino/list |
