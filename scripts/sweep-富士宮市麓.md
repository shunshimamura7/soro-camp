...
実行: 2026-08-15 11:46:22　/　`node scripts/district-sweep.js --district "富士宮市麓"`
...
| L2 | hinata スポット 御殿場・富士（tokai/shizuoka/2710） | OK | 58 | 3 | 一覧は先頭3ページまで |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 89 件 | **124** |
...
|---|---|---|---|---|---|---|
| 富士宮市観光協会 遊ぶ（?term=camp で絞り込み） | 12 | 0 | 2 | 2 | 8 | OK |
| フジヤマNAVI 富士宮市 × キャンプ | 17 | 0 | 2 | 3 | 12 | OK |
| なっぷ shizuoka/gotenba_fuzi | 20 | 0 | 0 | 8 | 12 | OK |
| じゃらん観光ガイド 富士宮市（cit_222070000 / ジャンル キャンプ・バンガロー・コテージ） | 12 | 0 | 1 | 0 | 11 | OK |
| hinata スポット 御殿場・富士（tokai/shizuoka/2710） | 58 | 0 | 3 | 0 | 55 | OK |
