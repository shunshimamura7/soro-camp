...
| L1 | 館山市公式「館山市内にあるキャンプ＆BBQ可能施設」 | **L1_NOT_FOUND** | – | – | **検索には出るが実物は404**（`/kankominato/page000001_00086.html`、2026-08-15 実測）。市公式にキャンプ場一覧があった痕跡はあるが、現行サイトでは辿り着けない。**検索結果のURLをそのまま登録しないこと**（内浦山で検索スニペットの料金が誤っていたのと同じ型）。checked には**生きている**観光トップを置く |
| L1 | 都道府県オープンデータ（千葉） | **L1_NOT_FOUND** | – | – | 未調査 |

**L1_NOT_FOUND は「探したが一覧が存在しない」。**「まだ探していない」とは違う。
次に見る人が同じ探索を繰り返さないために、確認したURLを残しておく。

- **館山市観光協会（tateyamacity.com）「キャンプ場」カテゴリ** — **カテゴリとしては存在するのに、施設の住所がどこにも無い。**`/camp` に「キャンプ場」カテゴリがあり、詳細（`/archives/2608` お台場海浜庭園など）も生きているが、**詳細ページに施設の住所が無く、ページ内で唯一の住所は「館山市北条1879-2」＝観光協会自身の所在地。****ここから住所を取ると §6-16 の借用をこちらから作る**（北杜市観光協会と完全に同じ型）。館山市は候補が2件（マリンサイド・キャンプマナビス）あって L1 が1本も無い市なので惜しいが、住所が取れない以上 L1 として登録しない
  - 確認: https://tateyamacity.com/camp
  - 確認: https://tateyamacity.com/archives/2608
- **館山市公式「館山市内にあるキャンプ＆BBQ可能施設」** — **検索には出るが実物は404**（`/kankominato/page000001_00086.html`、2026-08-15 実測）。市公式にキャンプ場一覧があった痕跡はあるが、現行サイトでは辿り着けない。**検索結果のURLをそのまま登録しないこと**（内浦山で検索スニペットの料金が誤っていたのと同じ型）。checked には**生きている**観光トップを置く
  - 確認: https://www.city.tateyama.chiba.jp/kankou-bunka/cate000153.html
...
- **confidence**: MID（層: L2）
- **住所**: 千葉県館山市波左間156
- **表記ゆれ**: 館山サザンビレッジ（旧：館山シーサイドビレッジ） / 館山サザンビレッジ
- **出典**:
...
- **confidence**: MID（層: L2）
- **住所**: 千葉県館山市見物12-1
- **表記ゆれ**: ブエナビスタビーチクラブ / ブエナビスタ ビーチクラブ
- **出典**:
  - `L2` なっぷ chiba/tateyama_minamiboso — https://www.nap-camp.com/chiba/tateyama_minamiboso/list
  - `L2` なっぷ chiba/tateyama_minamiboso — https://www.nap-camp.com/chiba/tateyama_minamiboso/list?page=2
...
| 合流先 | 分類 | 合流した住所なしの出典 |
|---|---|---|
| 館山サザンビレッジ（旧：館山シーサイドビレッジ） | MISSING | L2 nap-camp |
| ブエナビスタビーチクラブ | MISSING | L2 nap-camp |
