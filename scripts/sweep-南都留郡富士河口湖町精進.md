...
実行: 2026-08-15 11:44:02　/　`node scripts/district-sweep.js --district "南都留郡富士河口湖町精進"`
...
| `shojiko-camping` 精進湖キャンピングコテージ | 精進湖キャンピングコテージ | 名前 | LOW | L2 |
...
| hinata スポット 河口湖・西湖・富士吉田・精進湖・本栖湖（koushinetsu/yamanashi/2005） | 45 | 0 | 5 | 0 | 40 | OK |
