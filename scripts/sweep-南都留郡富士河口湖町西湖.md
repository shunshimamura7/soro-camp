...
実行: 2026-08-15 11:44:14　/　`node scripts/district-sweep.js --district "南都留郡富士河口湖町西湖"`
...
|---|---|---|---|---|
| `saiko-kohan-camp` 西湖湖畔キャンプ場 | 西湖湖畔キャンプ場 | 名前 | HIGH | L1+L2 |
| `saiko-jiyu` 西湖自由キャンプ場 | 西湖自由キャンプ場 | 名前 | HIGH | L1+L2+L3 |
| `saiko-tsuhara-camp` 西湖津原キャンプ場 | 西湖津原キャンプ場 | 名前 | HIGH | L1+L2 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 82 件 | **119** |
...
|---|---|---|---|---|---|---|
| 富士河口湖町観光連盟 富士河口湖町観光情報サイト 泊まる | 17 | 0 | 7 | 0 | 10 | OK |
| なっぷ yamanashi/motosuko_nishiko_kawaguchiko_fuzjiyoshida_shojiko | 20 | 0 | 2 | 6 | 12 | OK |
| じゃらん観光ガイド 富士河口湖町（cit_194300000 / ジャンル キャンプ・バンガロー・コテージ） | 22 | 0 | 13 | 0 | 9 | OK |
| hinata スポット 河口湖・西湖・富士吉田・精進湖・本栖湖（koushinetsu/yamanashi/2005） | 45 | 0 | 9 | 0 | 36 | OK |
...
| 合流先 | 分類 | 合流した住所なしの出典 |
|---|---|---|
| 西湖キャンプビレッジ・ノーム | MISSING | L2 nap-camp |
