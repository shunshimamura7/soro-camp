...
実行: 2026-08-15 11:49:39　/　`node scripts/district-sweep.js --district "相模原市緑区牧野"`
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 25 件 | **57** |
...
|---|---|---|---|---|---|---|
| 相模原市観光協会 キャンプ場一覧 | 22 | 0 | 3 | 1 | 18 | OK |
...
| hinata スポット 相模原（kanto/kanagawa/1906） | 29 | 0 | 3 | 0 | 26 | OK |
