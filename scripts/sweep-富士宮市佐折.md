...
実行: 2026-08-10 14:11:11　/　`node scripts/district-sweep.js --district "富士宮市佐折"`
...
| L2 | hinata スポット 御殿場・富士（tokai/shizuoka/2710） | OK | 58 | 2 | 一覧は先頭3ページまで / 住所を取りに行く詳細ページを 45 件で打ち切った（対象 58 件）。**打ち切った分はこの検査に載らない** |
...
|---|---|---|---|---|
| `tenshino-mori-camp` 天子の森オートキャンプ場 | 天子の森キャンプ場 | 名前 | MID | L2+L3 |
