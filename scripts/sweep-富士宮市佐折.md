...
実行: 2026-08-15 11:45:22　/　`node scripts/district-sweep.js --district "富士宮市佐折"`
...
| L2 | hinata スポット 御殿場・富士（tokai/shizuoka/2710） | OK | 58 | 2 | 一覧は先頭3ページまで |
...
|---|---|---|---|---|
| `tenshino-mori-camp` 天子の森オートキャンプ場 | 天子の森オートキャンプ場 | 名前 | HIGH | L1+L2+L3 |
| `tanukiko` 田貫湖キャンプ場 | 田貫湖キャンプ場 | 名前 | LOW | L2+L3 |
...
| **b2** | 住所はあるが**地区外**。うち市区町村も違う 89 件 | **126** |
...
| hinata スポット 御殿場・富士（tokai/shizuoka/2710） | 58 | 0 | 2 | 0 | 56 | OK |
